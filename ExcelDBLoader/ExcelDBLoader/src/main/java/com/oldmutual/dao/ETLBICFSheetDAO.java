...
public class ETLBICFSheetDAO {
    public static final String DATE_FORMAT = "dd MMM yyyy";
//    public static final String DATE_FORMAT = "dd-MM-yy";
    public static final String TIMESTAMP_FORMAT = "dd MMM yyyy, hh:mm:ss a";
    private static final Logger log = (Logger) LogManager.getLogger(ETLBICFSheetDAO.class);

    public void save(List<ETLBICFINDWizardScenario> bicfList) throws SQLException {
        Connection connection = null;
        final int BATCH_SIZE = 1000;
        final int DATA_SIZE = bicfList.size();
        try{
            ...
            if (connection != null){
                ...
                try(PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
                    ...
                    int index = 0;
                    for (ETLBICFINDWizardScenario ETLBICFINDWizardScenario : bicfList) {
                        index++;
